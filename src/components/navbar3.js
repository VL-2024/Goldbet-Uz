      ...
      <header data-thq="thq-navbar" className="navbar3-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar3-desktop-menu">
          <nav className="navbar3-links1">
            <Link to="/" className="navbar3-link11 thq-body-small thq-link">
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar3-text5">О нас</span>
                </Fragment>
              )}
            </Link>
            <Link to="/page" className="navbar3-link21 thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar3-text2">Указы и документы</span>
                </Fragment>
              )}
            </Link>
            <Link to="/1" className="navbar3-link31 thq-body-small thq-link">
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar3-text1">Получение лицензии</span>
                </Fragment>
              )}
            </Link>
            <a href={props.link5Url} className="thq-body-small thq-link">
              {props.link5 ?? (
                <Fragment>
                  <span className="navbar3-text3">Контакты</span>
                </Fragment>
              )}
            </a>
          </nav>
          <a
            href="https://t.me/+Uu49oi0hoE4ySflL"
            target="_blank"
          ...
          <div className="navbar3-nav">
            ...
            <nav className="navbar3-links2">
              ...
              <a href={props.link4Url} className="thq-body-small thq-link">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar3-text4">Portfolio</span>
                  </Fragment>
                )}
              </a>
              <a href={props.link5Url} className="thq-body-small thq-link">

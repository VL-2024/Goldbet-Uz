...
const Footer15 = (props) => {
  return (
    <footer
      id={props.footer15Id}
      className="footer15-container1 thq-section-padding"
    >
            ...
            <div className="footer15-newsletter">
              ...
              <div className="footer15-actions2">
                <div className="footer15-form">
                  ...
                  <a
                    href="mailto:support@goldbet.uz?subject=Вопрос с сайта Goldbet"
                    className="footer15-button thq-button-outline"
                  >
                    <span className="thq-body-small">
                      {props.action1 ?? (
                        <Fragment>
                          <span className="footer15-text1">Contact Us</span>
                        </Fragment>
                      )}
                    </span>
                  </a>
          ...
          <div className="footer15-row">
            <div className="footer15-credits2">
              <span className="thq-body-small">
                {props.privacyLink ?? (
                  <Fragment>
                    <span className="footer15-text7">Privacy Policy</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer15-text4">Terms of Service</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer15-text3">Cookies</span>
                  </Fragment>
                )}
              </span>
            </div>
